////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: mar ott 6 14:22:44 2015
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQPushButton(p,btn1,0);
  pvSetGeometry(p,btn1,162,99,183,72);
  pvSetText(p,btn1,pvtr("Struca el Boton"));
  pvSetFont(p,btn1,"Sans Serif",12,0,0,0,0);

  pvQLabel(p,lbl1,0);
  pvSetGeometry(p,lbl1,369,99,99,30);
  pvSetText(p,lbl1,pvtr("N"));
  pvSetFont(p,lbl1,"Sans Serif",12,1,0,0,0);
  pvSetStyle(p,lbl1,Box,-1,-1,-1);
  pvSetStyle(p,lbl1,-1,Sunken,-1,-1);

  pvQPushButton(p,btn2,0);
  pvSetGeometry(p,btn2,198,237,99,30);
  pvSetText(p,btn2,pvtr("Struca2"));
  pvSetFont(p,btn2,"Sans Serif",9,0,0,0,0);
